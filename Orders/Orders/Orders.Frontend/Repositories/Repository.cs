...
namespace Orders.Frontend.Repositories
{
    public class Repository : IRepository
    {
        ...
        public async Task<HttpResponseWrapper<T>> GetAsync<T>(string url)
        {
            ...
            {
                var response = await UnserializeAnsweAsync<T>(responseHttp);
        ...
        public async Task<HttpResponseWrapper<TActionResponse>> PostAsync<T, TActionResponse>(string url, T model)
        {
            ...
            if (responseHttp.IsSuccessStatusCode)
            {
                var response = await UnserializeAnsweAsync<TActionResponse>(responseHttp);
        ...
        private async Task<T> UnserializeAnsweAsync<T>(HttpResponseMessage responseHttp)
        {
